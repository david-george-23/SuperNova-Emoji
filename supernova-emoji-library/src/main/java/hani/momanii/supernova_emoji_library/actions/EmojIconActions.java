...
public class EmojIconActions implements View.OnFocusChangeListener {
  ...
  private boolean previousPopup = false;
  ...
  private EmojiPopupListener emojiPopupListener;
   ...
   */
  public EmojIconActions(Context ctx, View rootView, EmojiconEditText emojiconEditText, ImageView emojiButton, EmojiPopupListener emojiPopupListener) {
    this.emojiButton = emojiButton;
    this.context = ctx;
    this.emojiPopupListener = emojiPopupListener;
    ...
    popup.setOnSoftKeyboardOpenCloseListener(new EmojiconsPopup.OnSoftKeyboardOpenCloseListener() {
      ...
      public void onKeyboardClose() {
        if (keyboardListener != null) {
          ...
          keyboardListener.onKeyboardClose(previousPopup);
        }
        if (popup.isShowing()) {
//          popup.dismiss();
        }
  ...
  private void togglePopupVisibility() {
    if (!popup.isShowing()) {
      previousPopup = false;
      showPopup();
      emojiPopupListener.onEmojiPopupOpen();
    } else {
      previousPopup = true;
      emojiPopupListener.onEmojiPopupClose();
      hidePopup();
    }
  }
  ...
  public interface KeyboardListener {
    ...
    void onKeyboardClose(boolean wasPopUpOpen);
  }
  ...
  public interface EmojiPopupListener {
    void onEmojiPopupOpen();

    void onEmojiPopupClose();
  }
